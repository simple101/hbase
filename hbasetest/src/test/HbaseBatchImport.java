...
public class HbaseBatchImport {
	...
	static class BatchImportReducer extends Reducer<LongWritable, Text, NullWritable, Text>  {
...
//	  
////	        job.setOutputFormatClass(textin); 
////	        job.setInputFormatClass(TextInputFormat.class);  
//	        // 不再设置输出路径，而是设置输出格式类型  
////	        job.setOutputFormatClass(f);  
//	  
